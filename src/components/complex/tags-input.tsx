            ...
            >
                <div
                    ...
                    className={cn(
                        ...
                        "placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input flex h-full w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
                    ...
                    {value.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <RemoveIcon className="h-4 w-4 hover:opacity-50" />
                            </button>
                        </Badge>
                    ))}
                    <Input
                        ...
                        className={cn(
                            "outline-0 bg-transparent dark:bg-transparent dark:drop-shadow-none dark:shadow-none drop-shadow-none shadow-none border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1",
